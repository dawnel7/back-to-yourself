...
function renderTool(id){
  ...
  const bodies={
    ...
    feet:`<p class="exercise-intro">Let your attention come down toward your feet and the surface beneath you.</p><div class="practice-sequence"><div><strong>1</strong><span>Feel the surface beneath both feet.</span></div><div><strong>2</strong><span>Notice the weight of your body settling downward.</span></div><div><strong>3</strong><span>Press your feet gently into the floor for three breaths.</span></div><div><strong>4</strong><span>Look around and notice where you are.</span></div></div><button class="btn" onclick="finishTool('You gave your body a moment of contact and orientation.')">Done</button>`,
    ...
    orient:`<p class="exercise-intro">Let your eyes move slowly. You are not searching for anything special—just allowing your brain to take in the room.</p><div class="practice-sequence"><div><strong>1</strong><span>Find one color that catches your attention.</span></div><div><strong>2</strong><span>Notice the nearest doorway, window, or exit.</span></div><div><strong>3</strong><span>Find one object that is completely still.</span></div><div><strong>4</strong><span>Look farther away, then closer again.</span></div><div><strong>5</strong><span>Notice one thing that tells you you are safe enough in this moment.</span></div></div><button class="btn" onclick="finishTool('You oriented to the present moment.')">Done</button>`,

...
function renderTool(id){
  ...
  const bodies={
    ...
    feeling:`<p class="exercise-intro">Tap anything that fits. There may be more than one, and you can change your mind.</p><div class="chip-grid">${['calm','sad','angry','anxious','overwhelmed','lonely','numb','relieved','frustrated','tender','uncertain','content'].map(x=>`<button class="chip" onclick="this.classList.toggle('selected')">${x}</button>`).join('')}</div><p class="small center tool-note">No need to explain it. Naming it is enough.</p><button class="btn" onclick="finishTool('You noticed what is present without needing to fix it.')">Done</button>`,
    body:`<p class="exercise-intro">Bring your attention gently to your body. See what you notice without needing to make it mean anything.</p><div class="chip-grid">${['chest','throat','jaw','shoulders','belly','hands','head','back','legs','everywhere','nowhere'].map(x=>`<button class="chip" onclick="this.classList.toggle('selected')">${x}</button>`).join('')}</div><div class="choice-row"><button class="choice-btn" onclick="selectChoice(this)">tight</button><button class="choice-btn" onclick="selectChoice(this)">heavy</button><button class="choice-btn" onclick="selectChoice(this)">warm</button><button class="choice-btn" onclick="selectChoice(this)">cold</button><button class="choice-btn" onclick="selectChoice(this)">restless</button><button class="choice-btn" onclick="selectChoice(this)">numb</button><button class="choice-btn" onclick="selectChoice(this)">open</button></div><p class="small center tool-note">If your body could ask for one thing, what comes to mind: less, more, slower, space, movement, comfort?</p><button class="btn" onclick="finishTool('You listened without demanding an answer.')">Done</button>`,
